        ...
        <Stack  height="100vh" direction={{xs:"column", md:"row"}} justifyContent="space-evenly" marginTop={{xs:"5rem", md:0}} alignItems={"center"} gap='1rem'>
            ...
            <Stack height="100%" alignItems={"center"} justifyContent="center">
                ...
                <Typography sx={{textDecoration:"underline"}} fontSize={"large"} component={"h1"} mb={3} mt={3}  textAlign={"center"}>React SuperHeros</Typography>
                    <Typography component={"p"}>A flashy website for users to learn about their favorite super-powered characters from many different publishers This was a solo project I completed over the course of two weeks. It Displays Info and stats in the form of a graph for  hundreds of superheroes and villains. I obtained this data from the superHero API. I made my own node.js backend to organize the data In custom ways before being sent for display on the front end. </Typography>
                    </Box>
                    <Box margin={"0 auto"}>
